  ...
  return (
    <section id="ciudad" className="relative overflow-hidden">
      <div className="relative h-[80svh] min-h-[600px]">
        <img src={buenosAiresImg} alt="Vista aérea de Buenos Aires al atardecer con el Obelisco y la bandera argentina" loading="lazy" className="absolute inset-0 h-full w-full object-cover animate-slow-zoom" />

        <div className="relative z-10 h-full flex items-end pb-16 md:pb-24 px-6 md:px-12">
          <div className="mx-auto max-w-[1600px] w-full">
            <Reveal><p className="label-eyebrow mb-4 text-sol">03 · La ciudad</p></Reveal>
            <Reveal delay={100}>
        ...
        <div className="mx-auto max-w-[1600px] grid lg:grid-cols-12 gap-12">
          <Reveal className="lg:col-span-5">
            <p className="text-ivory/85 text-lg md:text-xl font-light leading-relaxed">
              Una ciudad que respira creatividad en cada esquina. París del Sur. Capital
              mundial del tango. Capital editorial de Latinoamérica. Una arquitectura
              construida para el espectáculo y una vida cultural imposible de imitar.
            </p>
          </Reveal>
          <div className="lg:col-span-7 grid grid-cols-2 md:grid-cols-4 gap-px bg-celeste-deep/40">
            {[
              ...
              <Reveal key={x.t} delay={i * 50} className="bg-ink p-5 hover:bg-celeste-deep/20 transition">
