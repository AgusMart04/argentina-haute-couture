      ...
      <div className="relative z-10 text-center px-6 max-w-6xl py-32">
        ...
        <Reveal delay={200}>
          <p className="mt-10 max-w-2xl mx-auto text-ivory/90 font-light text-xl">
            Patrocinadores, inversores, diseñadores, marcas y prensa — el primer capítulo se está
            escribiendo ahora. Y vos podés estar adentro.
          </p>
        </Reveal>
        <Reveal delay={300}>
          <div className="mt-12 flex flex-wrap items-center justify-center gap-4">
            <Link
              to="/contacto"
              className="group relative overflow-hidden bg-sol text-ink px-12 py-5 label-eyebrow hover:scale-105 hover:shadow-[0_30px_80px_-10px_rgba(245,180,0,0.9)] transition-all duration-300 shadow-[0_25px_70px_-15px_rgba(245,180,0,0.8)]"
            >
            ...
            <Link
              to="/contacto"
              className="label-eyebrow text-ivory border-2 border-ivory/60 px-12 py-5 hover:bg-ivory hover:text-ink transition"
            >
