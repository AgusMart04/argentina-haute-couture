      ...
      <div className="mx-auto max-w-[1600px] grid md:grid-cols-12 gap-12 items-start">
        <div className="md:col-span-5">
          ...
          <p className="mt-6 max-w-sm text-ivory/65 font-light leading-relaxed">
            El movimiento cultural que está poniendo a la Argentina en el mapa
            creativo del mundo.
          </p>
        </div>
        <div className="md:col-span-4 grid grid-cols-2 gap-8">
          <ul className="space-y-3 label-eyebrow text-ivory/70 text-xs">
            <li><Link to="/nuestra-esencia" className="hover:text-sol transition">Nuestra Esencia</Link></li>
            <li><Link to="/por-que-argentina" className="hover:text-sol transition">Por qué Argentina</Link></li>
          </ul>
          <ul className="space-y-3 label-eyebrow text-ivory/70 text-xs">
            <li><Link to="/aliados" className="hover:text-sol transition">Sumate</Link></li>
            <li><Link to="/contacto" className="hover:text-sol transition">Contacto</Link></li>
          </ul>
        </div>
        <div className="md:col-span-3 space-y-3 label-eyebrow text-ivory/70 text-xs">
          ...
          <a href="#" className="flex items-center gap-2 hover:text-sol transition">
            <svg className="h-4 w-4" viewBox="0 0 24 24" fill="currentColor"><path d="M19.59 6.69a4.83 4.83 0 01-3.77-4.25V2h-3.45v13.67a2.89 2.89 0 01-2.88 2.5 2.89 2.89 0 01-2.89-2.89 2.89 2.89 0 012.89-2.89c.28 0 .54.04.79.1v-3.5a6.37 6.37 0 00-.79-.05A6.34 6.34 0 003.15 15.2a6.34 6.34 0 0010.86 4.46V13a8.28 8.28 0 005.58 2.17v-3.44a4.85 4.85 0 01-2-.92V6.69h2z"/></svg>
            TikTok
          </a>
        </div>
      </div>
